...
<main class="main">
	...
	<section class="setting-container">
		...
		<article class="setting__content">
			...
			<!--프로필 수정-->
			<form id="profileUpdate" onsubmit="update(${principal.user.id}, event)"> <!-- onsubmit은 버튼을 눌렀을때 폼을 전달한다. -->
				...
				<div class="content-item__11">
					<div class="item__title"></div>
					<div class="item__input">
						<button>제출</button> <!-- 버튼이 form태그 안에 있으면 form의 이벤트가 발생함. 그래서 타입을 버튼으로 잡아줘야함 -->
					</div>
				</div>
				<!--제출버튼end-->
